...
//Deleting skills by Id
	...
	public static List<Skills> listProfilesBySkillName(String skill){  
        ...
        try{  
            ...
            PreparedStatement ps=con.prepareStatement("select profile.empId,profile.contactNo, profile.supervisorName,skills.experience, profile.businessUnitName, profile.cityName from skills inner join profile on skills.profileId = profile.profileId where skillName=?");  
